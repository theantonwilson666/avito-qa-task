...
## Комментарий:
Задание выполненено в полной мере, единственное что смутило в примере StructureWithValues.json у параметра "id":73 выстовлено значение
"value": "SellerX", хотя "values":354 в файле Values.json не соответствует id значению этого параметра("id" : 345)
